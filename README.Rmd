...
This package contains a function, count_all_missing_by_group(), which counts the missing values in a data set which grouped by one variable.
...
## Example
These are basic examples which show you how to solve common problems by using `count_all_missing_by_group()` function in countNAs:
